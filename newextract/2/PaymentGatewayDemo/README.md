...
This is a senior .NET interview demo project that shows a payment gateway-style architecture using ASP.NET Core Web APIs, Blazor Server, async API calls, dependency injection, inheritance, merchant lookup, and xUnit tests.
